...
public class LoginJFrame extends javax.swing.JFrame {
    ...
    public LoginJFrame() {
        ...
        btnEntrarLogin.addActionListener(evt -> btnEntrarLoginActionPerformed(evt));
        btnIrParaCadastro.addActionListener(evt -> btnIrParaCadastroActionPerformed(evt));
     ...
     */
    private void btnIrParaCadastroActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    CadastroJFrame telaCadastro = new CadastroJFrame();
    
    // PASSE O CONTROLLER ADIANTE:
    if (this.controller != null) {
        telaCadastro.setController(this.controller);
    }
    ...
    public static void main(String args[]) {
        // Define o visual do sistema (Nimbus)
        try {
